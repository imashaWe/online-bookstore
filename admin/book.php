...
if (isset($_POST['submit'])) {
    ...
    if (empty($name)) {
        ...
        if ($res->num_rows) {
            ...
            $sql = "INSERT INTO book(name,price,isbn,category_id,description) 
                VALUES('{$name}','{$price}','{$isbn}',{$category_id},'{$description}')";
            $res = $conn->query($sql);
            if ($res) {
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-select" name="sub_category_id">
                                        <?php while ($sub_category = $sub_categories->fetch_array()): ?>
                                            <option value="<?= $category['id'] ?>"><?= $sub_category['sub_category'] ?></option>
                                        <?php endwhile; ?>
                                    </select>
                                </div>
                                <div class="form-group">
